...
Checkm and GTDB need their databases as input. See [database section](../pipeline_configuration.md../pipeline_configuration.md##-Database-input-configuration) for possibly download strategies.
