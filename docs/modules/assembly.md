...
There are two different assemblers implemented: metaFlye and metaMDBG. Use metaMDBG if you have newer ONT data with flowcell R10.4+. Otherwise use metaFlye. Note that MetaCoAG does not work with metaMDBG since it needs the info file generated by metaFlye.
