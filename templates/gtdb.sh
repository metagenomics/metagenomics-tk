...
FILE_BAC="$(mktemp -u chunk_XXXXXXXXXX)_!{sample}_gtdbtk.bac120.summary.tsv"
FILE_ARC="$(mktemp -u chunk_XXXXXXXXXX)_!{sample}_gtdbtk.ar122.summary.tsv"
FILE_COMB="$(mktemp -u !{sample}_gtdbtk_XXXXXXX).tsv"
