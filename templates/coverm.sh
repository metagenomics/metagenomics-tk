...
coverm genome -t !{task.cpus}  --min-covered-fraction 0 -b !{mapping} --genome-fasta-list list.txt --methods count  --output-file $OUT/count.tsv  && sed -i '1 s| Read Count$||' $OUT/count.tsv || true
