...
/**
*
* This process executes MetaEuk.
* MetaEuk ishigh-throughput software toolkit designed for the discovery and annotation of protein-coding genes in eukaryotic metagenomic data.
* It is specifically engineered to handle the complexities of eukaryotic genomes, such as multi-exon gene architectures,
* which traditional prokaryotic gene predictors often fail to process accurately. 
*
**/
process pMetaEuk {
...
/**
* This workflow runs MetaEuk on a fasta file only if it was provided that the contig might be eukaryotic.
* For example by using whokaryote.
* 
