...
process pMMseqs2 {
      ...
      containerOptions Utils.constructParametersObject("mmseqs2", params?.steps?.annotation, params) + " --entrypoint='' " + Utils.getDockerNetwork()
...
process pMMseqs2_taxonomy {
      ...
      // Another mount flag is used to get a key file (aws format) into the docker-container. 
      // This file is then used by s5cmd. The necessary mount points are generated by “constructParametersObject()”. 
      containerOptions Utils.constructParametersObject("mmseqs2_taxonomy", params?.steps?.annotation, params) + " --entrypoint='' " + Utils.getDockerNetwork()
