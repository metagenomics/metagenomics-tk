...
bash ./scripts/test_SRA.sh " -c  test_data/assets/aws.config \
				      --input.SRA.NCBI.id 'SRR5651439' \
                                      ...
                                      --input.paired.r1 'https://openstack.cebitec.uni-bielefeld.de:8080/swift/v1/meta_test/small/read1_test1_1.fq.gz https://openstack.cebitec.uni-bielefeld.de:8080/swift/v1/meta_test/small/read1_test2_1.fq.gz' \
                                      --input.paired.r2 'https://openstack.cebitec.uni-bielefeld.de:8080/swift/v1/meta_test/small/read1_test1_1.fq.gz https://openstack.cebitec.uni-bielefeld.de:8080/swift/v1/meta_test/small/read1_test2_1.fq.gz' \
                                      --input.paired.names 'test1 test2' " \
